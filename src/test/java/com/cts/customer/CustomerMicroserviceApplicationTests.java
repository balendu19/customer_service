...
public class CustomerMicroserviceApplicationTests {
       ...
       public void testGetCustomers(){
              ...
              customerList.add(new Customer(1,"abcd","xyz","abc",123654,23));
              customerList.add(new Customer(2,"wxyz","xyz","abc",123654,23));
              customerList.add(new Customer(3,"abcdef","xyz","abc",123654,23));
       ...
       public void deleteCustomer(){
              Customer customer = new Customer(1,"abcd","xyz","abc",123654,23);
